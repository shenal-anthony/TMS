...
import { TextField, Button, Container, Typography, Card, MenuItem } from "@mui/material";
    ...
    <div className="flex min-h-screen">
      <div className="w-1/2 bg-gray-900 text-white flex flex-col items-center justify-center p-8">
        ...
        <Typography variant="body1" className="text-center">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vulpatae ut laoreet velit ma.
        </Typography>
      </div>
      <Container className="w-1/2 flex items-center justify-center">
        <Card className="p-8 shadow-xl w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <TextField label="Owner name" name="ownerName" fullWidth onChange={handleChange} required />
            ...
            <TextField select label="Vehicle type" name="vehicleType" fullWidth onChange={handleChange} value={formData.vehicleType}>
              <MenuItem value="Van">Van</MenuItem>
              <MenuItem value="Car">Car</MenuItem>
              <MenuItem value="Bike">Bike</MenuItem>
            </TextField>
            <TextField select label="Fuel type" name="fuelType" fullWidth onChange={handleChange} value={formData.fuelType}>
              <MenuItem value="Petrol">Petrol</MenuItem>
              <MenuItem value="Diesel">Diesel</MenuItem>
              <MenuItem value="Electric">Electric</MenuItem>
            </TextField>
            <TextField select label="Air condition" name="airCondition" fullWidth onChange={handleChange} value={formData.airCondition}>
            ...
            <Button variant="contained" component="label" fullWidth>
              ...
              <input type="file" name="vehiclePicture" hidden onChange={handleFileChange} />
            </Button>
            <Button variant="contained" component="label" fullWidth>
              Upload Tourist License
              <input type="file" name="touristLicense" hidden onChange={handleFileChange} />
            </Button>
