    ...
    <div class="min-h-screen flex flex-col bg-gray-50">
      ...
      <main class="flex-grow pt-16 container mx-auto px-4 py-8">
        <div class="max-w-6xl mx-auto">
          <h1 class="text-3xl font-bold text-gray-800 mb-8">Destination Gallery</h1>
          
          {/* Upload Section */}
          <div class="bg-white rounded-xl shadow-md p-6 mb-8">
            <h2 class="text-xl font-semibold text-gray-700 mb-4">Add New Destination</h2>
            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                <div class="flex items-center space-x-4">
                  <label class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
                    {previewUrl() ? (
                      <img src={previewUrl()} alt="Preview" class="h-full w-full object-cover rounded-lg" />
                    ) : (
                    ...
                    <input type="file" class="hidden" onChange={handleFileChange} accept="image/*" />
                  </label>
                </div>
              </div>
              ...
              >
                {isUploading() ? `Uploading... ${uploadProgress()}%` : "Upload Destination"}
              </button>
            </div>
          </div>
          ...
          <div class="bg-white rounded-xl shadow-md p-6">
            <div class="flex justify-between items-center mb-6">
              <h2 class="text-xl font-semibold text-gray-700">Explore Destinations</h2>
              <button 
            ...
            {destinations().length === 0 ? (
              <div class="text-center py-12">
                <p class="text-gray-500">No destinations found. Upload one to get started!</p>
              </div>
            ) : (
                    ...
                    <div class="group relative overflow-hidden rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                      ...
                      <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                        <div class="text-white">
                          <h3 class="font-bold text-lg">{destination.destination_name}</h3>
                      ...
                      <div class="p-4 bg-white">
                        <h3 class="font-semibold text-gray-800">{destination.destination_name}</h3>
                      </div>
                    </div>
                  )}
                </For>
