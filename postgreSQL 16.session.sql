...
-- ADD COLUMN leave_due_date DATE,
...
ADD COLUMN CREATE TABLE IF NOT EXISTS PUBLIC."guide_responses" (
...
-- Creating junction table for packages and destinations
CREATE TABLE IF NOT EXISTS PUBLIC."packages_destinations" (
	DESTINATION_ID INTEGER NOT NULL,
	PACKAGE_ID INTEGER NOT NULL,
	CONSTRAINT "packages_destinations_pkey" PRIMARY KEY (DESTINATION_ID, PACKAGE_ID),
	CONSTRAINT "fk_packages_destinations_destinations" FOREIGN KEY (DESTINATION_ID) REFERENCES PUBLIC."destinations" (DESTINATION_ID) ON DELETE CASCADE,
	CONSTRAINT "fk_packages_destinations_packages" FOREIGN KEY (PACKAGE_ID) REFERENCES PUBLIC."packages" (PACKAGE_ID) ON DELETE CASCADE
);
-- Creating junction table for packages and accommodations
CREATE TABLE IF NOT EXISTS PUBLIC."packages_accommodations" (
	ACCOMMODATION_ID INTEGER NOT NULL,
	PACKAGE_ID INTEGER NOT NULL,
	CONSTRAINT "packages_accommodations_pkey" PRIMARY KEY (ACCOMMODATION_ID, PACKAGE_ID),
	CONSTRAINT "fk_packages_accommodations_accommodations" FOREIGN KEY (ACCOMMODATION_ID) REFERENCES PUBLIC."accommodations" (ACCOMMODATION_ID) ON DELETE CASCADE,
	CONSTRAINT "fk_packages_accommodations_packages" FOREIGN KEY (PACKAGE_ID) REFERENCES PUBLIC."packages" (PACKAGE_ID) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS PUBLIC."tours_accommodations" (
	ACCOMMODATION_ID INTEGER NOT NULL,
	TOUR_ID INTEGER NOT NULL,
	CONSTRAINT "packageAccommodations_pkey" PRIMARY KEY (ACCOMMODATION_ID, TOUR_ID),
...
CREATE TABLE IF NOT EXISTS PUBLIC."tours_destinations" (
	DESTINATION_ID INTEGER NOT NULL,
	TOUR_ID INTEGER NOT NULL,
	CONSTRAINT "packageDestinations_pkey" PRIMARY KEY (DESTINATION_ID, TOUR_ID),
