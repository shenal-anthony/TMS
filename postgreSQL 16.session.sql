...
-- 	USER_ID INTEGER,
-- 	EVENT_ID INTEGER,
-- 	CONSTRAINT "fk_bookings_tourists" FOREIGN KEY (TOURIST_ID) REFERENCES PUBLIC."tourists" (TOURIST_ID) ON DELETE CASCADE,
-- 	CONSTRAINT "fk_bookings_payments" FOREIGN KEY (PAYMENT_ID) REFERENCES PUBLIC."payments" (PAYMENT_ID) ON DELETE SET NULL,
-- 	CONSTRAINT "fk_bookings_tours" FOREIGN KEY (TOUR_ID) REFERENCES PUBLIC."tours" (TOUR_ID) ON DELETE CASCADE,
-- 	CONSTRAINT "fk_bookings_users" FOREIGN KEY (USER_ID) REFERENCES PUBLIC."users" (USER_ID) ON DELETE SET NULL,
-- 	CONSTRAINT "fk_bookings_events" FOREIGN KEY (EVENT_ID) REFERENCES PUBLIC."events" (EVENT_ID) ON DELETE CASCADE
-- );
