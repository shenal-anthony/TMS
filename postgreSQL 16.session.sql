...
CREATE TABLE IF NOT EXISTS PUBLIC."vehicles" (
	...
	REGISTRATION_NUMBER CHARACTER VARYING(50) COLLATE PG_CATALOG."default",
	USER_ID INTEGER NOT NULL,
	CONSTRAINT "fk_vehicles_users" FOREIGN KEY (USER_ID) REFERENCES PUBLIC."users" (USER_ID) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS PUBLIC."bookings" (
	...
	USER_ID INTEGER NOT NULL,
	EVENT_ID INTEGER NOT NULL,
	CONSTRAINT "fk_bookings_tourists" FOREIGN KEY (TOURIST_ID) REFERENCES PUBLIC."tourists" (TOURIST_ID) ON DELETE SET NULL,
	CONSTRAINT "fk_bookings_tours" FOREIGN KEY (TOUR_ID) REFERENCES PUBLIC."tours" (TOUR_ID) ON DELETE SET NULL,
	CONSTRAINT "fk_bookings_users" FOREIGN KEY (USER_ID) REFERENCES PUBLIC."users" (USER_ID) ON DELETE SET NULL,
	CONSTRAINT "fk_bookings_events" FOREIGN KEY (EVENT_ID) REFERENCES PUBLIC."events" (EVENT_ID) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS PUBLIC."feedbacks" (
	...
	CONSTRAINT "fk_feedbacks_tourists" FOREIGN KEY (TOURIST_ID) REFERENCES PUBLIC."tourists" (TOURIST_ID) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS PUBLIC."packages" (
	...
	ACCOMMODATION_ID INTEGER NOT NULL,
	DESTINATION_ID INTEGER NOT NULL,
	CONSTRAINT "fk_packages_accommodations" FOREIGN KEY (ACCOMMODATION_ID) REFERENCES PUBLIC."accommodations" (ACCOMMODATION_ID) ON DELETE SET NULL,
	CONSTRAINT "fk_packages_destinations" FOREIGN KEY (DESTINATION_ID) REFERENCES PUBLIC."destinations" (DESTINATION_ID) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS PUBLIC."payments" (
	...
	STATUS CHARACTER VARYING(50) COLLATE PG_CATALOG."default",
	BOOKING_ID INTEGER NOT NULL,
	CONSTRAINT "fk_payments_bookings" FOREIGN KEY (BOOKING_ID) REFERENCES PUBLIC."bookings" (BOOKING_ID) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS PUBLIC."reports" (
	...
	USER_ID INTEGER NOT NULL,
	ROLE CHARACTER VARYING(50) COLLATE PG_CATALOG."default",
	CONSTRAINT "fk_reports_users" FOREIGN KEY (USER_ID) REFERENCES PUBLIC."users" (USER_ID) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS PUBLIC."reviews" (
	...
	TOURIST_ID INTEGER NOT NULL,
	PACKAGE_ID INTEGER NOT NULL,
	CONSTRAINT "fk_reviews_events" FOREIGN KEY (EVENT_ID) REFERENCES PUBLIC."events" (EVENT_ID) ON DELETE SET NULL,
	CONSTRAINT "fk_reviews_accommodations" FOREIGN KEY (ACCOMMODATION_ID) REFERENCES PUBLIC."accommodations" (ACCOMMODATION_ID) ON DELETE SET NULL,
	CONSTRAINT "fk_reviews_tours" FOREIGN KEY (TOUR_ID) REFERENCES PUBLIC."tours" (TOUR_ID) ON DELETE SET NULL,
	CONSTRAINT "fk_reviews_tourists" FOREIGN KEY (TOURIST_ID) REFERENCES PUBLIC."tourists" (TOURIST_ID) ON DELETE SET NULL,
	CONSTRAINT "fk_reviews_packages" FOREIGN KEY (PACKAGE_ID) REFERENCES PUBLIC."packages" (PACKAGE_ID) ON DELETE SET NULL
);
